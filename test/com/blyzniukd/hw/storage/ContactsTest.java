...
public class ContactsTest {
    ...
    private static final Contact SKYPE = new Contact(ContactType.SKYPE, new LinkDescription("dmitry_blyzniuk", "dmitry_blyzniuk"));
    private static final Contact EMAIL = new Contact(ContactType.EMAIL, new LinkDescription("blyzniukd@gmail.com", "blyzniukd@gmail.com"));
